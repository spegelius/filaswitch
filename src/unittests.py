...
from unittest_data_Cura import (
    pass1_testmodel1_Cura,
    pass1_testmodel1_retracts_Cura,
    pass2_testmodel1_towers_Cura,
    pass3_testmodel1_towers_Cura,
)
...
class TestTowers(unittest.TestCase):
    ...
    def test_towers_fill_gaps(self):
        ...
        for i in range(index):
            self.assertEqual(
                towers.get_tower_by_id(i).z, pass3_testmodel1_towers_Cura[i]
            )
...
class TestSettings(unittest.TestCase):
    ...
    def test_get_hw_config_array(self):
        ...
        result = self.settings.get_hw_config_array(
            "rapid.retract.initial[].length", _type=float
        )
